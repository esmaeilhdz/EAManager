...
//        $text = $this->EnToFa($text);
    ...
    public function convertModelNameToNamespace($model_name): string
    {
        return match ($model_name) {
            ...
            'design_model' => \App\Models\DesignModel::class,
        };
    }
     ...
     */
    public function makeTreeDepth(&$element, $parent_depth, int $max_depth = 0): mixed
    {
    ...
    public function EnToFa($string): array|string
    {
